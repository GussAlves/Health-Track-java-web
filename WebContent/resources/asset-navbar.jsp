...
<nav class="navbar navbar-expand-sm navbar-light bg-light">
	...
	<!-- início da div navegacao da navbar -->
	<div class="collapse navbar-collapse" id="navegacao">
		<!-- Início da lista da nav bar -->
		<ul class="navbar-nav ml-auto">
			<li class="nav-item">
				<!-- Início da item (nav-item) da navbar --> <a
			...
			<li class="nav-item">
				<!-- Início da item (nav-item) da navbar --> <a href="usuario.jsp"
				class="nav-link"> <!-- Início do icone utilizado para usuário -->
					<svg class="bi bi-person-circle" width="1em" height="1em"
						...
						xmlns="http://www.w3.org/2000/svg">
							...
							d="M8 1a7 7 0 1 0 0 14A7 7 0 0 0 8 1zM0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8z" />
                                </svg> <!-- Fechamento do icone utilizado para usuário -->
					Usuário
			</a>
			</li>
			<!-- final da item (nav-item) da navbar -->
			...
			<li class="nav-item">
				<!-- Início do item (nav-item) da navbar --> <a
				href="atividades.jsp" class="nav-link"> <!-- Início do icone utilizado para atividades -->
			...
			<!-- final da item (nav-item) da navbar -->
			<li class="nav-item">
				<!-- Início da item (nav-item) da navbar --> <a href="refeicao.jsp"
				class="nav-link"> <!-- Início do icone utilizado para dieta -->
			...
			<!-- Final da item (nav-item) da navbar -->
			<li class="nav-item">
				<!-- Início da item (nav-item) da navbar --> <a href="imc.jsp"
				class="nav-link "> <!-- Início do icone utilizado para Saúde -->
					<svg class="bi bi-heart-half" width="1em" height="1em"
						...
						xmlns="http://www.w3.org/2000/svg">
							...
							d="M8 2.748l-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01L8 2.748zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143c.06.055.119.112.176.171a3.12 3.12 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15z" />
								<!-- Final do icone utilizado para saúde -->
                            </svg> Saúde
			</a>
			</li>
			<!-- Final da item (nav-item) da navbar -->
			<li class="nav-item">
				<!-- Início da item (nav-item) da navbar --> <a href="login.jsp"
				class="nav-link"> <!-- Iníco do icone utilizado para Saír --> <svg
						...
						xmlns="http://www.w3.org/2000/svg">
                            ...
                            </svg> <!-- Final do icone utilizado para Saír -->
					Sair
			</a>
			</li>
			<!-- Final da item (nav-item) da navbar -->
